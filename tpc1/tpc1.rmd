...
output:
    pdf_document:
        ...
        keep_tex: false
        template: "`r paste(here::here(), '/template/Eisvogel/eisvogel.latex')`"
        temp: TODO https://stackoverflow.com/questions/45646135/evaluating-r-code-in-yaml-header
---
...
* \(A_n\) como o lançamento do primeiro dado e calhar n, \( n \in \mathbb{N} \cap [1, 6] \)
* \(B_n\) como o lançamento do segundo dado e calhar n, \( n \in \mathbb{N} \cap [1, 10] \)
